		...
		<div class="col-md-4 col-md-offset-4">
    		<div class="panel panel-default">
			  	<div class="panel-heading">
			    	<h3 class="panel-title">Creación de Sesión</h3>
			 	</div>
			  	<div class="panel-body">
			    	<form accept-charset="UTF-8" role="form" action="controllers/registro.php" method="POST">
						...
						<div class="form-group">
			    	  	...
			    	  	<div class="form-group">
			    		    <input class="form-control" placeholder="Correo Electronico" name="mails" type="text">
			    		</div>
			    		<div class="form-group">
			    			<input class="form-control" placeholder="Contrasenia" name="pass" type="password" value="">
			    		</div>
    ...
    <div class="row">
		<div class="col-md-4 col-md-offset-4">
    		<div class="panel panel-default">
			  	...
			  	<div class="panel-body">
			    	<form accept-charset="UTF-8" role="form" action="controllers/login.php" method="POST">
